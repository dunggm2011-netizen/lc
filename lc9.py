# =====================================================================
# LC79 TELE68 BOT v4 — 31 MODEL + ẢNH HOÀNG DÙNG STYLE
...
def generate_result_image(prediction, actual, dice, total, session_result,
    ...
    y = 522
    draw.text((35, y), "AI 68GB", fill=(0, 255, 200), font=font_info)
    draw.text((200, y), f"-- {TOOL_NAME}", fill=(255, 255, 255), font=font_info)

    y += 30
    draw.text((35, y), "Ban Xanh", fill=(255, 100, 100), font=font_info)
